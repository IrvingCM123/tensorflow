...
# model with the name "linear_model" and using the predictt interface.
SERVER_URL = 'https://linear-model-service-irvingcm123.cloud.okteto.net/v1/models/linear-model:predict'
